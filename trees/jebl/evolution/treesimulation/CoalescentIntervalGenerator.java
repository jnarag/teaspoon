 ...
 * @author Oliver Pybus
 * @version $Id: CoalescentIntervalGenerator.java 845 2007-11-22 15:51:58Z rambaut $
 */
public class CoalescentIntervalGenerator implements IntervalGenerator {

    public CoalescentIntervalGenerator(jebl.evolution.coalescent.DemographicFunction demographicFunction) {
        this.demographicFunction = demographicFunction;
    }

    protected jebl.evolution.coalescent.DemographicFunction demographicFunction;
