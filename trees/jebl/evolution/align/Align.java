...
public abstract class Align {
    ...
    jebl.evolution.align.scores.Scores sub;                     // scores matrix
    jebl.evolution.align.scores.Scores freeGapsSub;                     // scores matrix when free end gaps
    float d;                          // gap cost
    String seq1 = null;
    ...
    public Align(jebl.evolution.align.scores.Scores sub, float d) {
        setGapOpen(d);
        setScores(sub);
    }
    ...
    public void setScores(jebl.evolution.align.scores.Scores sub) {
        this.sub = sub;
        freeGapsSub = jebl.evolution.align.scores.Scores.duplicate(sub);
        for (int i = 0; i < 127; i++) {
