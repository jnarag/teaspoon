...
public class AlignCommand {
	...
	private void command(String sq1, String sq2) {
		...
		AlignSimple as = null;
		jebl.evolution.align.AlignAffine aa = null;
		jebl.evolution.align.AlignRepeat ar = null;
		jebl.evolution.align.AlignRepeatAffine ara = null;
		
		switch(input) {
			case 1:
				as = new jebl.evolution.align.NeedlemanWunsch(null, 0);
				break;
			case 2:
				aa = new NeedlemanWunschAffine(null, 0, 0);
				break;
			case 3:
				as = new jebl.evolution.align.NeedlemanWunschLinearSpace(null, 0);
				break;
			case 4:
				as = new jebl.evolution.align.OverlapAlign(null, 0);
				break;
			//case 5:
			//	ar = new RepeatAlign(null, 0, 0);
			//	break;
			case 6:
				as = new jebl.evolution.align.SmithWaterman(null, 0);
				break;
			case 7:
			...
			case 8:
				...
				break;
			case 9:
				ara = new jebl.evolution.align.NonOverlapMultipleLocalAffine(null, 0, 0, 0);
				break;
            case 10:
		...
		jebl.evolution.align.scores.Scores sub; //substitution matrix
		...
		if(!shuffle) {		//no shuffling
			...
			jebl.evolution.align.SequenceShuffler shuff = new jebl.evolution.align.SequenceShuffler();
			if(as != null) {
				start = System.currentTimeMillis();
				as.setGapOpen(gapOpen);
				as.setScores(sub);
