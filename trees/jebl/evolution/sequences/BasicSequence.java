...
public class BasicSequence implements Sequence {
    ...
    public BasicSequence(SequenceType sequenceType, jebl.evolution.taxa.Taxon taxon, CharSequence sequenceString) {
     ...
     * @param states
     */
    public BasicSequence(SequenceType sequenceType, jebl.evolution.taxa.Taxon taxon, State[] states) {
