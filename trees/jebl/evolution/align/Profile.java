...
/**
 * @author Matt Kearse
 * @version $Id: Profile.java 817 2007-10-16 22:21:28Z twobeers $
 *
...
//    int length;
    ...
    public Profile(jebl.evolution.alignments.Alignment alignment, int alphabetSize) {
        this(alignment, alphabetSize , 0);
    }

    public Profile(jebl.evolution.alignments.Alignment alignment, int alphabetSize, int offset) {
        this.alphabetSize = alphabetSize;
        final List<jebl.evolution.sequences.Sequence> sequenceList = alignment.getSequenceList();
