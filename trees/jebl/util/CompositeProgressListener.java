...
/**
 * A {@link ProgressListener} that is suitable for a task that consists of several subtasks.
 ...
 * that calling {@link ProgressListener#setComplete()} or {@link ProgressListener#setProgress(double) setProgress(1.0)}
 ...
 * @version $Id: CompositeProgressListener.java 944 2008-09-26 05:08:15Z matthew_cheung $
 */
public final class CompositeProgressListener extends ProgressListener {
    ...
    public CompositeProgressListener(ProgressListener listener, double ... operationDuration) {
        ...
        if (jebl.math.MachineAccuracy.same(totalTime, 0.0)) { // will always be the case if numOperations == 0
    ...
    /**
     * @return The root {@link ProgressListener} that this forwards adjusted progress reports to.
     */
