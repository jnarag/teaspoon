...
public abstract class ClusteringTreeBuilder<T extends Tree> implements jebl.evolution.trees.TreeBuilder<T> {
     ...
     */
    static public ClusteringTreeBuilder getBuilder(jebl.evolution.trees.TreeBuilderFactory.Method method, jebl.evolution.distances.DistanceMatrix distances) {
        ClusteringTreeBuilder builder;
        switch( method ) {
            case UPGMA:
            {
                builder = new jebl.evolution.trees.UPGMATreeBuilder(distances);
                break;
            }
     ...
     */
    protected ClusteringTreeBuilder(jebl.evolution.distances.DistanceMatrix distanceMatrix, int rootSubtrees) throws IllegalArgumentException {
    ...
    protected abstract jebl.evolution.graphs.Node createExternalNode(Taxon taxon);

    protected abstract jebl.evolution.graphs.Node createInternalNode(jebl.evolution.graphs.Node[] nodes, double[] distances);
    ...
    protected void init(final jebl.evolution.distances.DistanceMatrix distanceMatrix) {

        numClusters = distanceMatrix.getSize();
        clusters = new jebl.evolution.graphs.Node[numClusters];
    ...
    protected void newCluster() {
        ...
        jebl.evolution.graphs.Node[] n = { clusters[abi], clusters[abj] };
    ...
    final protected jebl.evolution.distances.DistanceMatrix distanceMatrix;

    // Number of current clusters
    protected int numClusters;

    // length numClusters
    protected jebl.evolution.graphs.Node[] clusters;
    protected jebl.evolution.graphs.Node newCluster;
