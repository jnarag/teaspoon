...
public class FastaExporter implements SequenceExporter {
     ...
     */
    public void exportSequences(Collection<? extends jebl.evolution.sequences.Sequence> sequences) throws IOException {
        for (jebl.evolution.sequences.Sequence sequence : sequences) {
            final jebl.evolution.taxa.Taxon taxon = sequence.getTaxon();
