 ...
 * @author Joseph Heled
 *
 * @version $Id: NexusExporter.java 932 2008-07-10 06:10:00Z stevensh $
 */
...
public class NexusExporter implements AlignmentExporter, SequenceExporter, TreeExporter {
     ...
     * export alignment.
     */
    public void exportSequences(Collection<? extends jebl.evolution.sequences.Sequence> sequences) throws IOException, IllegalArgumentException {
     ...
     * @param sequences
     */
    private void establishSequenceTaxa(Collection<? extends jebl.evolution.sequences.Sequence> sequences) {
        if( taxa != null && taxa.size() == sequences.size() ) {
            boolean hasAll = true;
            for( jebl.evolution.sequences.Sequence s : sequences ) {
