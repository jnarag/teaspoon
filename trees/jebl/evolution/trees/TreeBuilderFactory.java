...
public class TreeBuilderFactory {
     ...
     */
    static public ClusteringTreeBuilder getBuilder(Method method, jebl.evolution.distances.DistanceMatrix distances) {
    ...
    static public jebl.evolution.trees.ConsensusTreeBuilder buildUnRooted(Tree[] trees, jebl.evolution.taxa.Taxon outGroup, double supportThreshold, ConsensusMethod method) {
    ...
    // trees must have the same taxa
    static public jebl.evolution.trees.ConsensusTreeBuilder buildRooted(RootedTree[] trees, double supportThreshold, ConsensusMethod method) {
        if( ! (supportThreshold >= 0 && supportThreshold <= 1) ) {
     ...
     */
    static public jebl.evolution.trees.ConsensusTreeBuilder buildRooted(Tree[] trees, double supportThreshold, ConsensusMethod method) {
