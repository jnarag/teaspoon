...
public class RootedTreeComponent extends JComponent implements Printable {
     ...
     * @param tree the tree
     */
    public RootedTreeComponent(RootedTreePainter treePainter, jebl.evolution.trees.RootedTree tree) {
        this.treePainter = treePainter;
    ...
    */
     ...
     */
    protected void fireNodeClickedEvent(jebl.evolution.graphs.Node node) {
    ...
    public interface Listener {
        ...
        public void nodeClicked(jebl.evolution.trees.RootedTree tree, jebl.evolution.graphs.Node node);
    ...
    public class MListener extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent me) {
            ...
            jebl.evolution.graphs.Node node = treePainter.findNodeAtPoint(me.getPoint());
