...
public abstract class FilteredSequence implements Sequence {
    ...
    public String getString() {
        ...
        for (jebl.evolution.sequences.State aSequence : sequence) {
    ...
    public byte[] getStateIndices() {
        ...
        int i = 0;
        for (jebl.evolution.sequences.State state : sequence) {
    ...
    protected abstract jebl.evolution.sequences.State[] filterSequence(Sequence source);
    ...
    private jebl.evolution.sequences.State[] sequence = null;
}
