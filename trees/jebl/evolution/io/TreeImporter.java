 ...
 */
public interface TreeImporter extends Iterable<jebl.evolution.trees.Tree> {
     ...
     */
	jebl.evolution.trees.Tree importNextTree() throws IOException, ImportException;
     ...
     */
	List<jebl.evolution.trees.Tree> importTrees() throws IOException, ImportException;
}
