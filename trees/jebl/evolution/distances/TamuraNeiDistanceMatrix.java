 ...
 *
 * @author Joseph Heled
 * @version $Id: TamuraNeiDistanceMatrix.java 842 2007-11-12 22:33:48Z twobeers $
 *
...
public class TamuraNeiDistanceMatrix extends jebl.evolution.distances.BasicDistanceMatrix {
    ...
    static class Initializer extends ModelBasedDistanceMatrix implements PairwiseDistanceCalculator {
                ...
                throws CannotBuildDistanceMatrixException
        {
            ...
            return jebl.evolution.distances.BasicDistanceMatrix.buildDistancesMatrix(this, dimension, useTwiceMaximumDistanceWhenPairwiseDistanceNotCalculatable, progress);
        }
