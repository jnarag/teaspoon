...
public interface RootedTree extends Tree {
     ...
     */
    List<jebl.evolution.graphs.Node> getChildren(jebl.evolution.graphs.Node node);
     ...
     */
    double getHeight(jebl.evolution.graphs.Node node);
     ...
     */
    double getLength(jebl.evolution.graphs.Node node);
     ...
     */
    jebl.evolution.graphs.Node getParent(jebl.evolution.graphs.Node node);
     ...
     */
    jebl.evolution.graphs.Node getRootNode();
	 ...
	 */
	boolean isRoot(jebl.evolution.graphs.Node node);
}