 ...
 * @version $Id$
 */
public class CladeHeightMetric implements jebl.evolution.treemetrics.RootedTreeMetric {
	...
	private void getClades(Map<Taxon, Integer> taxonMap, jebl.evolution.trees.RootedTree tree, jebl.evolution.graphs.Node node,
