 ...
 * @version $Id: BasicLabelPainter.java 945 2008-09-29 23:29:42Z stevensh $
 */
public class BasicLabelPainter extends AbstractPainter<jebl.evolution.graphs.Node> {
    ...
    public BasicLabelPainter(String title, jebl.evolution.trees.RootedTree tree, PainterIntent intent) {
    ...
    public BasicLabelPainter(String title, jebl.evolution.trees.RootedTree tree, PainterIntent intent, int defaultSize) {
        this.title = title;
    ...
    public void setTree(jebl.evolution.trees.RootedTree tree) {
        this.tree = tree;
    }
    ...
    protected String getLabel(jebl.evolution.graphs.Node node) {
        String prefix = " ";
        String suffix = " ";
        ...
        if( tree instanceof jebl.evolution.trees.RootedTree) {
            final jebl.evolution.trees.RootedTree rtree = (jebl.evolution.trees.RootedTree) tree;
...
//    }
    ...
    public double getWidth(Graphics2D g2, jebl.evolution.graphs.Node item) {
    ...
    public void paint(Graphics2D g2, jebl.evolution.graphs.Node item, Painter.Justification justification, Rectangle2D bounds) {
        final Font oldFont = g2.getFont();
