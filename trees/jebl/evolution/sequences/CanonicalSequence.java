...
public class CanonicalSequence implements Sequence {
    ...
    public CanonicalSequence(SequenceType sequenceType, jebl.evolution.taxa.Taxon taxon, CharSequence sequenceString) {
     ...
     * @param states
     */
    public CanonicalSequence(SequenceType sequenceType, jebl.evolution.taxa.Taxon taxon, State[] states) {
