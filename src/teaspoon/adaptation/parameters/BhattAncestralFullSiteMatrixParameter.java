 ...
 * @version 0.1
 */
public class BhattAncestralFullSiteMatrixParameter extends AbstractBhattParameter {

	/**
	 * Explicit constructor with a double input type.
	 * @param double - substitution rate
	 */
	public BhattAncestralFullSiteMatrixParameter(BhattAdaptationFullSiteMatrix matrix){
		this.paramType = BhattParameterType.INT_MATRIX_ANCESTRAL;
