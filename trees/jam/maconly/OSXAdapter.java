...
public class OSXAdapter extends ApplicationAdapter {
    ...
    private virion.jam.framework.Application application;

    private OSXAdapter(virion.jam.framework.Application application) {
    ...
    // reflection.
    public static void registerMacOSXApplication(virion.jam.framework.Application application) {
