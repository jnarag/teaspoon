 ...
 * @version $Id: ScaleBarPainter.java 797 2007-09-28 02:47:26Z richardmoir $
 */
public class ScaleBarPainter extends AbstractPainter<jebl.gui.trees.treeviewer.TreePane> {
...
//        preferredWidth = treePane.getTreeScale() * scaleRange;
    ...
    public void paint(Graphics2D g2, jebl.gui.trees.treeviewer.TreePane treePane, Painter.Justification justification, Rectangle2D bounds) {
        Font oldFont = g2.getFont();
    ...
    public double getWidth(Graphics2D g2, jebl.gui.trees.treeviewer.TreePane treePane) {
        Font oldFont = g2.getFont();
        g2.setFont(scaleFont);
