...
public interface ParsimonyCriterion {
     ...
     */
    double[] getSiteScores(jebl.evolution.trees.Tree tree);
     ...
     */
    double getScore(jebl.evolution.trees.Tree tree);
     ...
     */
    jebl.evolution.sequences.State[] getStates(jebl.evolution.trees.Tree tree, jebl.evolution.graphs.Node node);
}
