...
public abstract class Scores implements ScoreMatrix {
    ...
    public static Scores duplicate(Scores scores) {
        ...
        } else if (scores instanceof jebl.evolution.align.scores.NucleotideScores) {
            result = new jebl.evolution.align.scores.NucleotideScores((jebl.evolution.align.scores.NucleotideScores) scores);
        } else {
