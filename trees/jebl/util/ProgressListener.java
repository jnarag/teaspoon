 ...
 * @author Matt Kearse
 *
 * @version $Id: ProgressListener.java 874 2008-01-17 02:58:56Z twobeers $
 *
...
/*    public final boolean setComplete() {
     ...
     * {@link #addFeedbackAction(String, virion.jam.util.SimpleListener)}.
     * @param label The  label used as a parameter to {@link #addFeedbackAction(String, virion.jam.util.SimpleListener)}
     */
