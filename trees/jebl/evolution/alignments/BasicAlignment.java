...
public class BasicAlignment implements Alignment {
     ...
     * @param sequences
     */
    public BasicAlignment(Collection<? extends jebl.evolution.sequences.Sequence> sequences) {
     ...
     * @param sequences
     */
    public BasicAlignment(jebl.evolution.sequences.Sequence[] sequences) {
        for (jebl.evolution.sequences.Sequence sequence : sequences) {
            put(sequence);
        }
        constructPatterns();
    ...
    public Set<jebl.evolution.sequences.Sequence> getSequences() {
        return new HashSet<jebl.evolution.sequences.Sequence>(sequences.values());
    }

    public List<jebl.evolution.sequences.Sequence> getSequenceList() {
        List<jebl.evolution.sequences.Sequence> seqs = new ArrayList<jebl.evolution.sequences.Sequence>();
    ...
    public List<jebl.evolution.alignments.Pattern> getPatterns() {
        return patterns;
    }
	 ...
	 */
	public void addSequence(jebl.evolution.sequences.Sequence sequence) {
	    put(sequence);
	    constructPatterns();
	}

    private void put(jebl.evolution.sequences.Sequence sequence) {
    ...
    private void constructPatterns() {
        ...
        int i = 0;
        int maxLen = 0;
        for (jebl.evolution.sequences.Sequence seq : getSequenceList()) {
    ...
    private Map<Taxon, jebl.evolution.sequences.Sequence> sequences = new HashMap<Taxon, jebl.evolution.sequences.Sequence>();
    private List<jebl.evolution.alignments.Pattern> patterns = new ArrayList<jebl.evolution.alignments.Pattern>();

    private class BasicPattern implements jebl.evolution.alignments.Pattern {
