...
public class ScoresFactory {
    ...
    public static AminoAcidScores[] getAvailableAminoAcidScores () {
        ...
        new jebl.evolution.align.scores.Blosum62(), new jebl.evolution.align.scores.Blosum65(), new jebl.evolution.align.scores.Blosum70(), new Blosum75 (), new Blosum80 (),
        new jebl.evolution.align.scores.Blosum85(), new Blosum90 (), new Pam100(),new Pam110 (), new Pam120 (),
        new jebl.evolution.align.scores.Pam130(),new Pam140 (), new Pam150 (), new Pam160 (), new jebl.evolution.align.scores.Pam170(),
        new jebl.evolution.align.scores.Pam180(), new jebl.evolution.align.scores.Pam190(), new jebl.evolution.align.scores.Pam200(), new jebl.evolution.align.scores.Pam210(), new Pam220 (),
        new Pam230 (), new Pam240 (), new jebl.evolution.align.scores.Pam250()};
    }
    public static jebl.evolution.align.scores.NucleotideScores[] getAvailableNucleotideScores () {
        return new jebl.evolution.align.scores.NucleotideScores[] {
                new jebl.evolution.align.scores.NucleotideScores("51% similarity", 5.0f, -3.0f),
                new jebl.evolution.align.scores.NucleotideScores("65% similarity", 5.0f, -4.0f),
               ...
               //  new NucleotideScores("93% similarity, Transition/Transversion", 1, -1,-5, 0),
                ...
                new jebl.evolution.align.scores.NucleotideScores("70% similarity (IUB)", 5 * 1.0f, 5 * -0.9f),
              ...
              //  new NucleotideScores("88% similarity", 5.0f, -7.2810419984342278f),
                new jebl.evolution.align.scores.NucleotideScores("93% similarity", 5.0f, -9.0261674571825044f),
