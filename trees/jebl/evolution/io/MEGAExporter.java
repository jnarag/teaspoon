...
public class MEGAExporter implements AlignmentExporter {
    ...
    /**
     * @deprecated Files created by this export method won't be importable by MEGA (because they don't have titles).  Use {@link #exportAlignment(Alignment, String)}  instead.
     * @param alignment
     * @throws IOException
     */
    public void exportAlignment(Alignment alignment) throws IOException {
        List<jebl.evolution.sequences.Sequence> seqs = alignment.getSequenceList();

        for( jebl.evolution.sequences.Sequence seq : seqs )  {
            writer.println();
